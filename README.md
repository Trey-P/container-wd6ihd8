...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-wd6ihd8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-wd6ihd8.containers.anotherwebservice.com/
...
```
git clone git@github.com:Trey-P/container-wd6ihd8.git
cd container-wd6ihd8
```
...
```
docker attach container-wd6ihd8
```
